    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 
            className="text-4xl md:text-5xl fond-bold mt-4 mb-6 animate-fade-in animation-delay-100 text-secondary-foreground"
          >
            Experience that {" "} 
          ...
          <p 
            className="text-muted-forground, animate-fade-in animation-delay-200"
          >
          ...
          <div className="space-y-12">
            {experiences.map((exp, idx) =>(
              ...
              >
                ...
                {/* Timeline Dot */}
                <div className="absolute left-0 md:left-1/2 top-0 w-3 h-3 bg-primary rounded-full -translate-x-1/2 ring- ring-background4 z-10">
