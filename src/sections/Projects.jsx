    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mx-auto max-w-3xl mb-16">
          ...
          <h2 className="text-secondary-foreground text-4xl md:text-5xl font-bold mt-4 mb-6 animate-fade-in animation-delay-100">
            Projects that{" "}
            <span className="font-serif italic font-normal text-white">
              make an impact
            </span>
          </h2>
          <p className="text-muted-forground, animate-fade-in animation-delay-200">
            A selection of my recent work, someof my University projects as well as my private projects
          </p>
        </div>
