  ...
  return (
    ...
    <div className="absolute inset-0">
      <img 
        src="/hero-bg.jpg" 
        alt="Hero bg" 
        className="w-full h-full obj-cover opacity-40" 
      />
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p
            className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-300">
              Hi, I'm Rajeev Sharma - a software engineer
            </p>
          </div>
